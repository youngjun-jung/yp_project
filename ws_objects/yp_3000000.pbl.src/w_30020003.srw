$PBExportHeader$w_30020003.srw
forward
global type w_30020003 from w_ancestor_08
end type
...
ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/productstotal", 'GET', ls_body)
...
on w_30020003.create
int iCurrent
call super::create
end on

on w_30020003.destroy
call super::destroy
end on
...
type sle_id from w_ancestor_08`sle_id within w_30020003
end type

type tab_1 from w_ancestor_08`tab_1 within w_30020003
...
type dw_cdt from w_ancestor_08`dw_cdt within w_30020003
...
type st_1 from w_ancestor_08`st_1 within w_30020003
end type
