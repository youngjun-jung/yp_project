$PBExportHeader$w_30010004.srw
forward
global type w_30010004 from w_ancestor_03
end type
end forward
...
global w_30010004 w_30010004

type variables
Long il_chk_cnt
end variables

on w_30010004.create
call super::create
end on

on w_30010004.destroy
call super::destroy
end on
...
ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/agbyproducts", 'GET', ls_body)
...
for ll_index = 1 to ll_count    
	...
	dw_1.object.lname[ll_row] = lnv_json.getitemstring( ll_child, "gubun")  
	dw_1.object.mname[ll_row] = lnv_json.getitemstring( ll_child, "gubun1")  
	dw_1.object.sname[ll_row] = lnv_json.getitemstring( ll_child, "gubun2")  
...
type dw_1 from w_ancestor_03`dw_1 within w_30010004
string dataobject = "d_30010004"
end type
...
type sle_id from w_ancestor_03`sle_id within w_30010004
integer x = 238
integer y = 2592
end type

type dw_cdt from w_ancestor_03`dw_cdt within w_30010004
string dataobject = "d_30010004_cdt"
end type
...
type st_1 from w_ancestor_03`st_1 within w_30010004
end type
