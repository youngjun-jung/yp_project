$PBExportHeader$w_20030004.srw
forward
global type w_20030004 from w_ancestor_08
end type
...
if as_gubun = '0' then
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/laborcostt", 'GET', ls_body)	
else
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/laborcost", 'GET', ls_body)	
end if
...
on w_20030004.create
int iCurrent
call super::create
end on

on w_20030004.destroy
call super::destroy
end on
...
type sle_id from w_ancestor_08`sle_id within w_20030004
end type

type tab_1 from w_ancestor_08`tab_1 within w_20030004
integer x = 219
integer y = 492
tabpage_2 tabpage_2
tabpage_3 tabpage_3
...
type dw_cdt from w_ancestor_08`dw_cdt within w_20030004
string dataobject = "d_20030004_cdt"
end type
...
type st_1 from w_ancestor_08`st_1 within w_20030004
end type
...
integer y = 16
integer taborder = 10
string dataobject = "d_20030004_1"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030004_2"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030004_3"
end type
