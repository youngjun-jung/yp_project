...
//	If ls_filename = "." Or ls_filename = ".." Or Then
	If ls_filename = "hreload.exe" Or Right(ls_filename, 3) = "pbd" Or Right(ls_filename, 3) = "ini" Or Right(ls_filename, 3) = "dll" Or Right(ls_filename, 3) = "jpg" Or Right(ls_filename, 3) = "jpeg" Or Right(ls_filename, 3) = "gif" Or Right(ls_filename, 3) = "ico" Then
		// check for hidden attrib
		lb_hidden = of_checkbit(lstr_fd.dwFileAttributes, 2)
		lb_system = of_checkbit(lstr_fd.dwFileAttributes, 3)
		lb_subdir = of_checkbit(lstr_fd.dwFileAttributes, 5)
