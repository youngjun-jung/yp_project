$PBExportHeader$w_30010003.srw
forward
global type w_30010003 from w_ancestor_03
end type
end forward
...
global w_30010003 w_30010003

type variables
Long il_chk_cnt
end variables

on w_30010003.create
call super::create
end on

on w_30010003.destroy
call super::destroy
end on
...
ls_result = gf_api_call("http://localhost:3000/api/ref2", 'GET', ls_body)
...
for ll_index = 1 to ll_count    
	...
	dw_1.object.xd[ll_row] = lnv_json.getitemnumber( ll_child, "month_01")  
	dw_1.object.xe[ll_row] = lnv_json.getitemnumber( ll_child, "month_02")  
	dw_1.object.xf[ll_row] = lnv_json.getitemnumber( ll_child, "month_03")  
	dw_1.object.xg[ll_row] = lnv_json.getitemnumber( ll_child, "month_1")  
	dw_1.object.xh[ll_row] = lnv_json.getitemnumber( ll_child, "month_04")  
	dw_1.object.xi[ll_row] = lnv_json.getitemnumber( ll_child, "month_05")  
	dw_1.object.xj[ll_row] = lnv_json.getitemnumber( ll_child, "month_06")  
	dw_1.object.xk[ll_row] = lnv_json.getitemnumber( ll_child, "month_2")  
	dw_1.object.xl[ll_row] = lnv_json.getitemnumber( ll_child, "month_07")  
	dw_1.object.xm[ll_row] = lnv_json.getitemnumber( ll_child, "month_08")  
	dw_1.object.xn[ll_row] = lnv_json.getitemnumber( ll_child, "month_09")  
	dw_1.object.xo[ll_row] = lnv_json.getitemnumber( ll_child, "month_3")  
	dw_1.object.xp[ll_row] = lnv_json.getitemnumber( ll_child, "month_10")  
	dw_1.object.xq[ll_row] = lnv_json.getitemnumber( ll_child, "month_11")  
	dw_1.object.xr[ll_row] = lnv_json.getitemnumber( ll_child, "month_12")  
	dw_1.object.xs[ll_row] = lnv_json.getitemnumber( ll_child, "month_4")    
...
type dw_cdt from w_ancestor_03`dw_cdt within w_30010003
string dataobject = "d_30010003_cdt"
end type
...
type st_1 from w_ancestor_03`st_1 within w_30010003
end type
