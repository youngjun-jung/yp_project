$PBExportHeader$w_mainmdi.srw
forward
global type w_mainmdi from window
end type
type mdi_1 from mdiclient within w_mainmdi
end type
type d_toolbar from u_dw_toolbar within w_mainmdi
end type
type p_1 from picture within w_mainmdi
end type
type dw_1 from datawindow within w_mainmdi
end type
type dw_menu from datawindow within w_mainmdi
end type
type uo_tab from u_tab within w_mainmdi
end type
type uo_tab from u_tab within w_mainmdi
end type
type tv_menu from datawindow within w_mainmdi
end type
end forward
...
public subroutine wf_menu (string as_p_menuid)
end prototypes
...
public subroutine wf_menu (string as_p_menuid);Long ll_row, i
...
for i = 1 to dw_1.rowcount()
	...
	IF mid(gs_p_menuid[i], 1, 1) <> as_p_menuid THEN CONTINUE;
		...
		tv_menu.object.adm_menu_cs_menuname[ll_row] = gs_menunm[i] 
		tv_menu.object.adm_menu_cs_p_menuname[ll_row] = gs_p_menunm[i] 
		
		tv_menu.object.adm_menu_cs_screen_id[ll_row] = gs_screenid[i] 
		tv_menu.object.adm_menu_cs_p_menuid[ll_row] = gs_p_menuid[i] 
		tv_menu.object.adm_menu_cs_menuid[ll_row] = gs_menuid[i] 
		
		tv_menu.object.adm_menu_cs_menu_fun1[ll_row] = mid(gs_menufun[i], 1, 1)
		tv_menu.object.adm_menu_cs_menu_fun2[ll_row] = mid(gs_menufun[i], 2, 1)
		tv_menu.object.adm_menu_cs_menu_fun3[ll_row] = mid(gs_menufun[i], 3, 1)
		tv_menu.object.adm_menu_cs_menu_fun4[ll_row] = mid(gs_menufun[i], 4, 1)
		tv_menu.object.adm_menu_cs_menu_fun5[ll_row] = mid(gs_menufun[i], 5, 1)
		tv_menu.object.adm_menu_cs_menu_fun6[ll_row] = mid(gs_menufun[i], 6, 1)
		tv_menu.object.adm_menu_cs_menu_fun7[ll_row] = mid(gs_menufun[i], 7, 1)
		tv_menu.object.adm_menu_cs_menu_fun8[ll_row] = mid(gs_menufun[i], 8, 1)
		tv_menu.object.adm_menu_cs_menu_fun9[ll_row] = mid(gs_menufun[i], 9, 1)
...
for i = 1 to dw_1.rowcount()
	...
	gs_p_menunm[i] = dw_1.object.p_menuname[i]
