...
forward
global type w_30010006 from w_ancestor_03
end type
end forward
...
ls_result = gf_api_call("http://localhost:3000/api/selfconsumption", 'GET', ls_body)
...
type dw_1 from w_ancestor_03`dw_1 within w_30010006
...
type sle_id from w_ancestor_03`sle_id within w_30010006
integer x = 238
integer y = 2592
end type

type dw_cdt from w_ancestor_03`dw_cdt within w_30010006
...
type st_1 from w_ancestor_03`st_1 within w_30010006
end type
