...
forward
global type w_10020001 from w_ancestor_03
end type
type cb_1 from commandbutton within w_10020001
end type
type cb_2 from commandbutton within w_10020001
end type
type cb_3 from commandbutton within w_10020001
end type
end forward
...
type dw_1 from w_ancestor_03`dw_1 within w_10020001
...
type sle_id from w_ancestor_03`sle_id within w_10020001
integer x = 238
integer y = 2592
end type

type dw_cdt from w_ancestor_03`dw_cdt within w_10020001
string dataobject = "d_10010001_cdt"
end type

type st_1 from w_ancestor_03`st_1 within w_10020001
end type
