$PBExportHeader$n_upgrade_res.sru
$PBExportComments$File Upgrade
forward
global type n_upgrade_res from datastore
end type
type filetime from structure within n_upgrade_res
end type
type systemtime from structure within n_upgrade_res
end type
type win32_find_data from structure within n_upgrade_res
end type
end forward
...
global n_upgrade_res n_upgrade_res
...
//	If ls_filename = "." Or ls_filename = ".." Or Then
	If Right(ls_filename, 3) = "ico" Or Right(ls_filename, 3) = "gif" Or Right(ls_filename, 3) = "png" Or Right(ls_filename, 3) = "jpg"Then
		// check for hidden attrib
		lb_hidden = of_checkbit(lstr_fd.dwFileAttributes, 2)
		lb_system = of_checkbit(lstr_fd.dwFileAttributes, 3)
		lb_subdir = of_checkbit(lstr_fd.dwFileAttributes, 5)
...
on n_upgrade_res.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_upgrade_res.destroy
