$PBExportHeader$w_20030003.srw
forward
global type w_20030003 from w_ancestor_08
end type
...
if as_gubun = '0' then
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/submaterialt", 'GET', ls_body)	
else
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/submaterial", 'GET', ls_body)	
end if
...
on w_20030003.create
int iCurrent
call super::create
end on

on w_20030003.destroy
call super::destroy
end on
...
type sle_id from w_ancestor_08`sle_id within w_20030003
end type

type tab_1 from w_ancestor_08`tab_1 within w_20030003
integer x = 219
integer y = 492
tabpage_2 tabpage_2
tabpage_3 tabpage_3
...
type dw_cdt from w_ancestor_08`dw_cdt within w_20030003
string dataobject = "d_20030003_cdt"
end type
...
type st_1 from w_ancestor_08`st_1 within w_20030003
end type
...
integer y = 16
integer taborder = 10
string dataobject = "d_20030003_1"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030003_2"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030003_3"
end type
