$PBExportHeader$w_20030007.srw
forward
global type w_20030007 from w_ancestor_08
end type
...
if as_gubun = '0' then
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/depreciationt", 'GET', ls_body)	
else
	ls_result = gf_api_call("http://" + gl_api_ip + ":" + gl_api_port + "/api/depreciation", 'GET', ls_body)	
end if
...
for ll_index = 1 to ll_count    
	...
	tab_1.tabpage_2.dw_2.object.xo[ll_row] = lnv_json.getitemnumber( ll_child, "xo")  
	tab_1.tabpage_2.dw_2.object.xp[ll_row] = lnv_json.getitemnumber( ll_child, "xp")  
	tab_1.tabpage_2.dw_2.object.xq[ll_row] = lnv_json.getitemnumber( ll_child, "xq")  
	tab_1.tabpage_2.dw_2.object.xr[ll_row] = lnv_json.getitemnumber( ll_child, "xr")  
	tab_1.tabpage_2.dw_2.object.xs[ll_row] = lnv_json.getitemnumber( ll_child, "xs")  
	tab_1.tabpage_2.dw_2.object.xt[ll_row] = lnv_json.getitemnumber( ll_child, "xt")  
	tab_1.tabpage_2.dw_2.object.xu[ll_row] = lnv_json.getitemnumber( ll_child, "xu")  
	tab_1.tabpage_2.dw_2.object.xv[ll_row] = lnv_json.getitemnumber( ll_child, "xv")  
	tab_1.tabpage_2.dw_2.object.xw[ll_row] = lnv_json.getitemnumber( ll_child, "xw")  
	tab_1.tabpage_2.dw_2.object.xx[ll_row] = lnv_json.getitemnumber( ll_child, "xx")  
	tab_1.tabpage_2.dw_2.object.xy[ll_row] = lnv_json.getitemnumber( ll_child, "xy")  
	tab_1.tabpage_2.dw_2.object.xz[ll_row] = lnv_json.getitemnumber( ll_child, "xz")  	
	tab_1.tabpage_2.dw_2.object.xaa[ll_row] = lnv_json.getitemnumber( ll_child, "xaa")  
	tab_1.tabpage_2.dw_2.object.idx[ll_row] = lnv_json.getitemnumber( ll_child, "idx")  
...
for ll_index = 1 to ll_count    
	...
	tab_1.tabpage_3.dw_3.object.gubun[ll_row] = lnv_json.getitemString( ll_child, "gubun")  
	...
	tab_1.tabpage_3.dw_3.object.xo[ll_row] = lnv_json.getitemnumber( ll_child, "xo")  
	tab_1.tabpage_3.dw_3.object.xp[ll_row] = lnv_json.getitemnumber( ll_child, "xp")  
	tab_1.tabpage_3.dw_3.object.xq[ll_row] = lnv_json.getitemnumber( ll_child, "xq")  
	tab_1.tabpage_3.dw_3.object.xr[ll_row] = lnv_json.getitemnumber( ll_child, "xr")  
	tab_1.tabpage_3.dw_3.object.xs[ll_row] = lnv_json.getitemnumber( ll_child, "xs")  
	tab_1.tabpage_3.dw_3.object.xt[ll_row] = lnv_json.getitemnumber( ll_child, "xt")  
	tab_1.tabpage_3.dw_3.object.xu[ll_row] = lnv_json.getitemnumber( ll_child, "xu")  
	tab_1.tabpage_3.dw_3.object.xv[ll_row] = lnv_json.getitemnumber( ll_child, "xv")  
	tab_1.tabpage_3.dw_3.object.xw[ll_row] = lnv_json.getitemnumber( ll_child, "xw")  
	tab_1.tabpage_3.dw_3.object.xx[ll_row] = lnv_json.getitemnumber( ll_child, "xx")  
	tab_1.tabpage_3.dw_3.object.xy[ll_row] = lnv_json.getitemnumber( ll_child, "xy")  
	tab_1.tabpage_3.dw_3.object.xz[ll_row] = lnv_json.getitemnumber( ll_child, "xz")  	
	tab_1.tabpage_3.dw_3.object.xaa[ll_row] = lnv_json.getitemnumber( ll_child, "xaa")  
	tab_1.tabpage_3.dw_3.object.idx[ll_row] = lnv_json.getitemnumber( ll_child, "idx")  
...
on w_20030007.create
int iCurrent
call super::create
end on

on w_20030007.destroy
call super::destroy
end on
...
type sle_id from w_ancestor_08`sle_id within w_20030007
end type

type tab_1 from w_ancestor_08`tab_1 within w_20030007
integer x = 219
integer y = 488
tabpage_2 tabpage_2
tabpage_3 tabpage_3
...
type dw_cdt from w_ancestor_08`dw_cdt within w_20030007
string dataobject = "d_20030007_cdt"
end type
...
type st_1 from w_ancestor_08`st_1 within w_20030007
end type
...
integer y = 16
integer taborder = 10
string dataobject = "d_20030007_1"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030007_2"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030007_3"
end type
