$PBExportHeader$w_20030002.srw
forward
global type w_20030002 from w_ancestor_08
end type
...
if as_gubun = '0' then
	ls_result = gf_api_call("http://localhost:3000/api/otherexpensest", 'GET', ls_body)	
else
	ls_result = gf_api_call("http://localhost:3000/api/otherexpenses", 'GET', ls_body)	
end if
...
on w_20030002.create
int iCurrent
call super::create
end on

on w_20030002.destroy
call super::destroy
end on
...
type sle_id from w_ancestor_08`sle_id within w_20030002
end type

type tab_1 from w_ancestor_08`tab_1 within w_20030002
integer x = 219
integer y = 492
tabpage_2 tabpage_2
tabpage_3 tabpage_3
...
type dw_cdt from w_ancestor_08`dw_cdt within w_20030002
string dataobject = "d_20030002_cdt"
end type
...
type st_1 from w_ancestor_08`st_1 within w_20030002
end type
...
integer y = 16
integer taborder = 10
string dataobject = "d_20030002_1"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030002_2"
end type
...
integer y = 16
integer taborder = 20
string dataobject = "d_20030002_3"
end type
