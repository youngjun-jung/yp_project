$PBExportHeader$w_ancestor_01.srw
forward
global type w_ancestor_01 from w_ancestor
end type
type dw_1 from u_dw_grid within w_ancestor_01
end type
type sle_id from singlelineedit within w_ancestor_01
end type
type dw_cdt from u_dw_cdt within w_ancestor_01
end type
type st_1 from statictext within w_ancestor_01
end type
end forward
...
global w_ancestor_01 w_ancestor_01

on w_ancestor_01.create
int iCurrent
call super::create
