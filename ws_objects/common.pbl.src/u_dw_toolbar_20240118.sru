$PBExportHeader$u_dw_toolbar_20240118.sru
$PBExportComments$Datawindow Toolbar UserObject
forward
global type u_dw_toolbar_20240118 from datawindow
end type
end forward
...
global u_dw_toolbar_20240118 u_dw_toolbar_20240118
...
IF NOT Right(is_old_object, 2) = Right(ls_now_object, 2) THEN
	...
	IF (NOT dwo.Type = 'column') OR (ib_lbtn_clicking) THEN		// Not Column, Not Button Clicking
		is_old_object = ""
		RETURN
	END IF
...
on u_dw_toolbar_20240118.create
end on

on u_dw_toolbar_20240118.destroy
end on
